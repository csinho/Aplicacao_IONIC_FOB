...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__contact_contact__ = __webpack_require__(416);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__home_home__ = __webpack_require__(417);
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Poly\Desktop\FOB\src\pages\tabs\tabs.html"*/'<ion-tabs color="plmd">\n  <ion-tab [root]="tab1Root" tabTitle="HOJE" tabIcon="md-home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="BUSCAR" tabIcon="md-search"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="STATUS" tabIcon="md-stats"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\Users\Poly\Desktop\FOB\src\pages\tabs\tabs.html"*/
        }),
...
var AboutPage = /** @class */ (function () {
    function AboutPage(modalCtrl, alertCtrl, loadingCtrl, db, navCtrl) {
        ...
        this.meses = ["JAN", "FEV", "MAR", "ABR", "MAI", "JAN", "JUL", "AGO", "SET", "OUT", "NOV", "DEZ"];
    ...
    AboutPage.prototype.hora = function () {
        var ontem = new Date(this.myDate.getTime());
        ontem.setDate(this.myDate.getDate() - 1);
        var amanha = new Date(this.myDate.getTime());
        amanha.setDate(this.myDate.getDate() + 1);
        var dd_o = ontem.getDate();
        var mm_o = ontem.getMonth() + 1;
        var yyy_o = ontem.getFullYear();
        var dd_a = amanha.getDate();
        var mm_a = amanha.getMonth() + 1;
        var yyy_a = amanha.getFullYear();
        var ddd_a;
        var ddd_o;
        var mmm_o;
        var mmm_a;
        ...
        this.data_ontem = yyy_o + '-' + mmm_o + '-' + dd_o;
        this.data_amanha = yyy_a + '-' + mmm_a + '-' + dd_a;
        this.data_dia_ontem = dd_o + '/' + mmm_o + '/' + yyy_o;
        this.data_dia_amanha = dd_a + '/' + mmm_a + '/' + yyy_a;
    };
    ...
    AboutPage.prototype.getPorCte = function (cte) {
        var _this = this;
        var CTE = parseInt(cte);
        var z;
        for (var i = 0; i < this.MesesANO.length; i++) {
            this.db.list(this.MesesANO[i])
                .valueChanges()
    ...
    AboutPage.prototype.getPorNfe = function (nfe) {
        var _this = this;
        var NFE = parseInt(nfe);
        var z;
        for (var i = 0; i < this.MesesANO.length; i++) {
            this.db.list(this.MesesANO[i])
                .valueChanges()
    ...
    AboutPage.prototype.getOntem = function () {
        ...
        this.db.list(this.mes, function (ref) { return ref.orderByChild('Data_Programada').equalTo(_this.data_ontem + "T03:00:00.000Z"); })
            ...
            var d = "ontem";
            _this.ontem_amannha(_this._ontem, d, _this.data_dia_ontem);
        }, function (err) {
            console.log("Problema : ", err);
        });
    };
    AboutPage.prototype.getAmanha = function () {
        ...
        this.db.list(this.mes, function (ref) { return ref.orderByChild('Data_Programada').equalTo(_this.data_amanha + "T03:00:00.000Z"); })
            ...
            var d = "amanha";
            _this.ontem_amannha(_this._amanha, d, _this.data_dia_amanha);
        }, function (err) {
            console.log("Problema : ", err);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_screen_orientation__ = __webpack_require__(418);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.ionViewDidLoad = function () {
        ...
        this.screenOrientation.onChange()
            .subscribe(function (value) { return console.log("Orientação"); }, function (error) { return console.log(error); }, function () { return console.log(); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_contact_contact__ = __webpack_require__(416);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_angularfire2__ = __webpack_require__(622);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ng2_charts_x__ = __webpack_require__(623);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_screen_orientation__ = __webpack_require__(418);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_11_angularfire2__["AngularFireModule"].initializeApp({
                    apiKey: "AIzaSyDtoCo6kuRBUz3m_yH6K5_nTW0f3ylllhc",
                    authDomain: "tabela-de-dados.firebaseapp.com",
                    databaseURL: "https://tabela-de-dados.firebaseio.com",
                    projectId: "tabela-de-dados",
                    storageBucket: "tabela-de-dados.appspot.com",
                    messagingSenderId: "486433037467",
                    appId: "1:486433037467:web:05e71bf8a9438f7d"
                }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Poly\Desktop\FOB\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\Poly\Desktop\FOB\src\app\app.html"*/
        }),
